/******************************************************************
 *
 * @(#)$Id: db2APRS.c,v 1.2 2004/06/10 23:51:28 we7u Exp $
 *
...

{
    ...
    sprintf(query_buffer,"SELECT value,sensorid,fieldid FROM sdata WHERE timekey = %s", last_timestamp);
