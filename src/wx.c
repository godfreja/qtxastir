/*
 * $Id: wx.c,v 1.78 2012/08/13 17:22:34 tvrusso Exp $
 *
...
// New code, fix by Matt Werner, kb0kqa:
        ...
        case (DAVISAPRSDL):
            ...
            if (sscanf((char *)data,
              ...
              if (debug_level & 1)
                fprintf(stdout,"Davis APRS DataLogger Decode $Revision: 1.78 $: wd-%s,ws-%s,wg-%s,t-%s,rh-%s,r24-%s,r00-%s,h-%s,ap-%s,station-%s\n",
