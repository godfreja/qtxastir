/*
 * $Id: wx.c,v 1.77 2012/05/31 18:49:52 tvrusso Exp $
 *
...
// New code, fix by Matt Werner, kb0kqa:
        ...
        case (DAVISAPRSDL):
            ...
            if (sscanf((char *)data,
              ...
              if (debug_level & 1)
                fprintf(stdout,"Davis APRS DataLogger Decode $Revision: 1.77 $: wd-%s,ws-%s,wg-%s,t-%s,rh-%s,rt-%s,h-%s,ap-%s,station-%s\n",
