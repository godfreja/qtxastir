/*
 * $Id: track_gui.c,v 1.1.1.1 2002/02/02 03:19:23 kg4ijb Exp $
 *
...
begin_critical_section(&track_station_dialog_lock, "track_gui.c:Track_station" );
        ...
        track_station_dialog = XtVaCreatePopupShell(langcode("WPUPTSP001"),xmDialogShellWidgetClass,Global.top,
                                  XmNdeleteResponse,XmDESTROY,
                                  XmNdefaultPosition, FALSE,
                                  NULL);

        pane = XtVaCreateWidget("Track_station pane",xmPanedWindowWidgetClass, track_station_dialog,
                          XmNbackground, colors[0xff],
                          NULL);

        my_form =  XtVaCreateWidget("Track_station my_form",xmFormWidgetClass, pane,
                            XmNfractionBase, 3,
                            XmNbackground, colors[0xff],
        ...
        call = XtVaCreateManagedWidget(langcode("WPUPTSP002"),xmLabelWidgetClass, my_form,
        ...
        track_station_data = XtVaCreateManagedWidget("Track_station track locate data", xmTextFieldWidgetClass, my_form,
                                      XmNeditable,   TRUE,
        ...
        track_case_data  = XtVaCreateManagedWidget(langcode("WPUPTSP003"),xmToggleButtonWidgetClass,my_form,
        ...
        track_match_data  = XtVaCreateManagedWidget(langcode("WPUPTSP004"),xmToggleButtonWidgetClass,my_form,
                                      XmNtopAttachment, XmATTACH_WIDGET,
                                      XmNtopWidget, call,
                                      XmNtopOffset, 20,
                                      XmNbottomAttachment, XmATTACH_NONE,
        ...
        sep = XtVaCreateManagedWidget("Track_station sep", xmSeparatorGadgetClass,my_form,
        ...
        button_ok = XtVaCreateManagedWidget(langcode("WPUPTSP005"),xmPushButtonGadgetClass, my_form,
                                      XmNtopAttachment, XmATTACH_WIDGET,
                                      XmNtopWidget, sep,
                                      XmNtopOffset, 5,
        ...
        button_clear = XtVaCreateManagedWidget(langcode("WPUPTSP006"),xmPushButtonGadgetClass, my_form,
                                      XmNtopAttachment, XmATTACH_WIDGET,
                                      XmNtopWidget, sep,
                                      XmNtopOffset, 5,
                                      XmNbottomAttachment, XmATTACH_FORM,
...
begin_critical_section(&download_findu_dialog_lock, "track_gui.c:Download_findu_trail" );
        ...
        download_findu_dialog = XtVaCreatePopupShell(langcode("WPUPTSP007"),xmDialogShellWidgetClass,Global.top,
                                  XmNdeleteResponse,XmDESTROY,
                                  XmNdefaultPosition, FALSE,
                                  NULL);

        pane = XtVaCreateWidget("Download_findu_trail pane",xmPanedWindowWidgetClass, download_findu_dialog,
                          XmNbackground, colors[0xff],
                          NULL);

        my_form =  XtVaCreateWidget("Download_findu_trail my_form",xmFormWidgetClass, pane,
                            XmNfractionBase, 2,
                            XmNbackground, colors[0xff],
                            XmNautoUnmanage, FALSE,
                            XmNshadowThickness, 1,
        ...
        call = XtVaCreateManagedWidget(langcode("WPUPTSP008"),xmLabelWidgetClass, my_form,
                                      XmNtopAttachment, XmATTACH_FORM,
                                      XmNtopOffset, 10,
                                      XmNbottomAttachment, XmATTACH_NONE,
                                      XmNleftAttachment, XmATTACH_FORM,
        ...
        download_trail_station_data = XtVaCreateManagedWidget("download_trail_station_data", xmTextFieldWidgetClass, my_form,
                                      XmNeditable,   TRUE,
                                      XmNcursorPositionVisible, TRUE,
                                      XmNsensitive, TRUE,
                                      XmNshadowThickness,    1,
        ...
        button_ok = XtVaCreateManagedWidget(langcode("WPUPTSP007"),xmPushButtonGadgetClass, my_form,
                                      XmNtopAttachment, XmATTACH_WIDGET,
                                      XmNtopWidget, sep,
                                      XmNtopOffset, 5,
                                      XmNbottomAttachment, XmATTACH_FORM,
