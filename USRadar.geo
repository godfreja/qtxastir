#
# $Id: USRadar.geo,v 1.3 2004/03/13 04:54:58 we7u Exp $
#
#US Composite Radar image (Unidata/LDM/Gempak) n5jxs 2003 08 25
# Modified for accuracy, comments:  n5jxs 2004 03 12
#
# If you want to get a different image-type, change the selection
# below by removing the '#' from the front of the URL, and placing a
# '#' before all URLs for image-types you don't want.  I don't know
# what will happen if you have multiple URLs selected.
...
# Image extents: Lat: 25.0N to 50.0N, Lon: 65.0W to 125.0W (-65.0 to
# -125.0)
# Image size extents: X: 6000 pixels, Y: 2500 pixels (.01 deg/pixel)
IMAGESIZE 6000 2500
#
